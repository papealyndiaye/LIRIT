    ...
    return (
      <div className="min-h-full">
        <nav className="bg-gray-800">
              ...
              <div className="hidden md:block">
                <div className="ml-4 flex items-center md:ml-6">
                  ...
                  <div className="relative ml-3">
                    <button type="button" className="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-none">
                    ...
                    {/* Dropdown menu (à implémenter si besoin) */}
                  </div>
                </div>
              </div>
              <div className="-mr-2 flex md:hidden">
                {/* Mobile menu button (non fonctionnel ici) */}
                <button type="button" className="relative inline-flex items-center justify-center rounded-md bg-gray-800 p-2 text-gray-400 hover:bg-gray-700 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 focus:outline-none">
          ...
          {/* Mobile menu (non fonctionnel ici) */}
        </nav>
        ...
        <main>
          <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            {/* Your content */}
            <div className="text-gray-700">Bienvenue dans votre espace membre !</div>
          </div>
        </main>
      </div>
    );
      ...
      <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              className="flex w-full justify-center rounded-md bg-white px-3 py-1.5 text-base font-semibold text-indigo-600 shadow-sm ring-1 ring-gray-900/10 hover:ring-gray-900/20 focus:outline-2 focus:outline-indigo-600 focus:outline-offset-2 sm:text-sm"
            >
              Se connecter
            </button>
          </div>
